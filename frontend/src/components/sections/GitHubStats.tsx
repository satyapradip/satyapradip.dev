...
import { GitCommit, Code, Terminal, Flame, Cpu } from "lucide-react";
import { githubStatsData } from "@/constants/achievements";
 ...
 * 
 * Renders developer metric counters (commits, algorithms solved, projects built)
      ...
      <RevealOnScroll direction="up" className="mt-8">
        <div className="bg-surface brutalist-border brutalist-shadow p-6 md:p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-primary-container p-6 brutalist-border text-center">
            ...
            {/* Metric 3: Projects Built */}
            <div className="bg-secondary-container p-6 brutalist-border text-center">
            ...
            {/* Metric 4: Passion Rating */}
            <div className="bg-tertiary-container p-6 brutalist-border text-center">
              <Flame className="h-7 w-7 text-on-surface mx-auto mb-2" />
              <div className="font-display font-black text-3xl md:text-4xl text-on-surface">
                100%
              </div>
              <p className="font-sans font-bold text-xs uppercase tracking-wider text-on-surface mt-2">
